...
export default function Home() {
      ...
      <Head>
        ...
        <div class="hero min-h-screen bg-base-200">
          <div class="hero-content text-center">
            <div class="max-w-lg">
              <h1 class="text-xl font-bold mb-10">{currentSatoshiTime ? currentSatoshiTime : ''}</h1>
              <h1 class="text-md font-bold mb-10">Satoshi was first seen {HumanElapsed(timeAfterSatoshi)} ago</h1>
              <p>
              ...
              <h1 class="text-3xl font-bold mt-10">How does is work?</h1>
              <p class="text-2xl font-bold mt-10 mb-10">
  ...
  <pre><code>let secondsSinceSatoshi = moment().unix() - moment.utc('2008-10-31 18:10:00 UTC', '"YYYY-MM-DD HH:MM:SS"').unix();</code></pre>
              ...
              <button class="btn btn-primary mt-10">Learn More</button>
            </div>
          </div>
        </div>
